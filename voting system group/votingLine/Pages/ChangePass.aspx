<%@ Page Title="" Language="C#" MasterPageFile="~/Main.master" AutoEventWireup="true" CodeFile="ChangePass.aspx.cs" Inherits="ChangePass" %>
    ...
    <table class="ctable" style="height:100px" align ="center" width="1000">
        ...
        <tr>
            ...
            <td class="style10">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" 
                    ControlToValidate="txtVId" ErrorMessage="Enter Voter Id " ForeColor="Red"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td class="style5">
                New Password</td>
            <td class="style4">
                <asp:TextBox ID="txtVId1" runat="server" Height="30px" Width="180px" 
               TextMode="Password"></asp:TextBox>
                <asp:Label ID="Label3" runat="server" ForeColor="Red" Text="*"></asp:Label>
            </td>
            <td>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" 
                    ControlToValidate="txtVId1" ErrorMessage="Enter New Password" ForeColor="Red"></asp:RequiredFieldValidator>
                <br />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" 
                    ControlToValidate="txtVId1" ErrorMessage="Password Must Be 4 to 6 Characters" 
        ...
        <tr>
            <td class="style5">
                Confirm Password</td>
            <td class="style4">
                <asp:TextBox ID="txtVId2" runat="server" Height="30px" Width="180px" 
                    TextMode="Password"></asp:TextBox>
                <asp:Label ID="Label4" runat="server" ForeColor="Red" Text="*"></asp:Label>
            </td>
            <td>
                <asp:CompareValidator ID="CompareValidator1" runat="server" 
                    ControlToCompare="txtVId1" ControlToValidate="txtVId2" 
